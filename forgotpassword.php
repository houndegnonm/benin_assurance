...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<?php echo APP_URL; ?>/register.php" class="btn btn-danger">Request an account</a> </span>
							...
							<form action="<?php echo APP_URL; ?>/login.php" id="login-form" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
										...
										<div class="note">
											<a href="<?php echo APP_URL ?>/home.php">I remembered my password!</a>
										</div>
									</section>
